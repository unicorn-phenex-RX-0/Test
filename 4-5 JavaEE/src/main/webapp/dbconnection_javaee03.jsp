...
<p>検索条件、または、登録情報(name,price)を入力してください</p>
  ...
  ${error2}  price: <input type="text" name="price"><br>
    <button type="submit" name="btn" value ="select">検索</button> <button type="submit" name="btn" value ="register">登録</button> <button type="submit" name="btn" value ="update">更新</button>
  </form>
<p>検索結果</p>
  <table border="1">
    <tr>
